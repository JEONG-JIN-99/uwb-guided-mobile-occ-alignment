...
def main():
    parser = argparse.ArgumentParser(
        description="Rx experiment: track a moving UWB target with yaw gimbal."
    )
        ...
        while not stop_event.is_set():
            ...
            try:
                ...
                try:
                    ...
                    # The main loop and receiver raced; the queue already
                    # contains a packet that is at least as recent.
                    pass
    ...
    try:
        ...
        experiment_id = result_logger.experiment_id
        ...
        print(
            f"[LOG] experiment_id={experiment_id}, "
