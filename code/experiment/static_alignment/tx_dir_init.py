#!/usr/bin/env python3
"""정적 정렬 실험 전에 Tx GPIO yaw 짐벌을 0도로 맞춘다."""
...
def build_parser():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "to 0 degrees before static alignment."
        )
    )
    parser.add_argument(
        "--yaw-pin",
